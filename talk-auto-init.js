...
// 配置信息
const config = {
  username: 'DaXiongzx', // GitHub repository 所有者，可以是个人或者组织。对应Gitalk配置中的owner
  repo: "DaXiongzx.github.io", // 储存评论issue的github仓库名，仅需要仓库名字即可。对应 Gitalk配置中的repo
  token: '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', // 前面申请的 personal access token
